...
export default function FlowPage(props: FlowPageProps) {
  ...
  async function fetchListPageByFlowId() {
  ...
  return <PostcardMain headtitle={"Scrapings"} headurl={"/scrapings"}
    ...
    <div className="row g-2">
      ...
      <div className="col-md-6 col-lg-3">
        ...
        <small>
          ...
          {" of "}
          {data.pages.map(page => page.places.success + page.places.ignored).reduce((accumulator, currentValue) => accumulator + currentValue)}</small>
      </div>
    </div>
